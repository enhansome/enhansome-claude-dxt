...
* [milisp/codexia](https://github.com/milisp/codexia) ⭐ 890 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-19 - The missing GUI for the OpenAI Codex CLI, (FileTree + notepad + git diff) all in a lightweight Tauri desktop app.
...
* [DXT Specification](https://github.com/anthropics/dxt) ⭐ 2,083 | 🐛 95 | 🌐 TypeScript | 📅 2026-05-26 - Open-source toolchain and specs
* [Official examples](https://github.com/anthropics/dxt/tree/main/examples) ⭐ 2,083 | 🐛 95 | 🌐 TypeScript | 📅 2026-05-26 - Official examples
...
* [taylorwilsdon/google\_workspace\_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) ⭐ 3,037 | 🐛 174 | 🌐 Python | 📅 2026-08-18 - Full natural language control over Google Calendar, Drive, Gmail, Docs, Sheets, Slides, Forms, Tasks and Chat through all MCP clients, AI assistants and developer tools
...
* [bgauryy/octocode-mcp](https://github.com/bgauryy/octocode-mcp) ⭐ 915 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-18 - GitHub code search and npm package exploration MCP server

### Development Tools

* [modelcontextprotocol/gitlab](https://github.com/modelcontextprotocol/servers/blob/main/src/gitlab) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - GitLab API, enabling project management
* [modelcontextprotocol/git](https://github.com/modelcontextprotocol/servers/blob/main/src/git) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - Tools to read, search, and manipulate Git repositories
* [modelcontextprotocol/sentry](https://github.com/modelcontextprotocol/servers/blob/main/src/sentry) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - Retrieving and analyzing issues from Sentry.io
* [21st-dev/magic-mcp](https://github.com/21st-dev/magic-mcp) ⭐ 5,691 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-31 - Magic Component Platform (MCP) is a powerful AI-driven tool that helps developers create beautiful, modern UI components instantly through natural language descriptions. It integrates seamlessly with popular IDEs and provides a streamlined workflow for UI development.
* [lingodotdev/lingo.dev](https://github.com/lingodotdev/lingo.dev) ⭐ 5,406 | 🐛 41 | 🌐 TypeScript | 📅 2026-08-19 - The [Model Context Protocol](https://modelcontextprotocol.io/introduction) (MCP) is a standard for connecting Large Language Models (LLMs) to external services. This guide will walk you through how to connect AI tools to Lingo.dev using MCP.
* [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) ⭐ 4,093 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-11 - Model Context Protocol (MCP) is a [new, standardized protocol](https://modelcontextprotocol.io/introduction) for managing context between large language models (LLMs) and external systems. In this repository, we provide an installer as well as an MCP Server for [Cloudflare's API](https://api.cloudflare.com).
* [chrome-applescript](https://github.com/anthropics/dxt/tree/main/examples/chrome-applescript) ⭐ 2,083 | 🐛 95 | 🌐 TypeScript | 📅 2026-05-26 - Browser automation via AppleScript
* [manusa/kubernetes-mcp-server](https://github.com/manusa/kubernetes-mcp-server) ⭐ 1,979 | 🐛 99 | 🌐 Go | 📅 2026-08-18 - A powerful Kubernetes MCP server with additional support for OpenShift. Besides providing CRUD operations for any Kubernetes resource, this server provides specialized tools to interact with your cluster.
...
* [JetBrains/mcp-jetbrains](https://github.com/JetBrains/mcp-jetbrains) ⭐ 967 | 🐛 40 | 🌐 JavaScript | 📅 2026-01-07 - The server proxies requests from client to JetBrains IDE.
...
* [kubestellar/console (kc-agent)](https://github.com/kubestellar/console) ⭐ 127 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-19 - AI-powered multi-cluster Kubernetes dashboard with a built-in MCP server (`kc-agent`) that exposes live fleet data (pods, deployments, Helm releases, GPU inventory, compliance policies) to any MCP-compatible AI agent — no cluster-side install required.
...
* [supernovae-st/nika](https://github.com/supernovae-st/nika) ⭐ 54 | 🐛 26 | 🌐 Rust | 📅 2026-08-19 - Read-only oracle for Nika AI workflows: validate `.nika.yaml` files, explain findings, and estimate cost before running — the MCP server ships inside the single Rust binary, with signed `.mcpb` bundles (macOS arm64 + Linux x64) on each release.
...
* [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) ⭐ 9,349 | 🐛 201 | 🌐 TypeScript | 📅 2026-08-19 📇 🏠 🍎 🪟 🐧 - A swiss-army-knife that can manage/execute programs and read/write/search/edit code and text files.
* [daxaur/openpaw](https://github.com/daxaur/openpaw) ⭐ 160 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-23 - A CLI tool that adds 39 personal assistant skills to Claude Code — focus mode, task dashboard, smart home, email, calendar, and more.

### File Management

* [file-manager-python](https://github.com/anthropics/dxt/tree/main/examples/file-manager-python) ⭐ 2,083 | 🐛 95 | 🌐 TypeScript | 📅 2026-05-26

### System Tools

* [modelcontextprotocol/time](https://github.com/modelcontextprotocol/servers/blob/main/src/time) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - A Model Context Protocol server that provides time and timezone conversion capabilities. It automatically detects the system's timezone and offers tools for getting current time and converting between timezones.
* [modelcontextprotocol/filesystem](https://github.com/modelcontextprotocol/servers/blob/main/src/filesystem) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - Secure file operations with configurable access controls
...
* [modelcontextprotocol/google-maps](https://github.com/modelcontextprotocol/servers/blob/main/src/google-maps) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - Location services, directions, and place details

* [modelcontextprotocol/brave-search](https://github.com/modelcontextprotocol/servers/blob/main/src/brave-search) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - Web and local search using Brave's Search API

* [modelcontextprotocol/fetch](https://github.com/modelcontextprotocol/servers/tree/main/src/fetch) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - A Model Context Protocol server that provides web content fetching capabilities.

* [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 36,270 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-17 - A Model Context Protocol (MCP) server that provides browser automation capabilities using [Playwright](https://playwright.dev). This server enables LLMs to interact with web pages through structured accessibility snapshots, bypassing the need for screenshots or visually-tuned models.

* [mendableai/firecrawl-mcp-server](https://github.com/mendableai/firecrawl-mcp-server) ⭐ 7,268 | 🐛 153 | 🌐 JavaScript | 📅 2026-08-18 - Advanced web scraping with JavaScript rendering, PDF support, and smart rate limiting
...
* [exa-labs/exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) ⭐ 4,889 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-18 - A Model Context Protocol (MCP) server lets AI assistants like Claude use the Exa AI Search API for web searches. This setup allows AI models to get real-time web information in a safe and controlled way.

* [apify/actors-mcp-server](https://github.com/apify/actors-mcp-server) ⭐ 4,203 | 🐛 136 | 🌐 TypeScript | 📅 2026-08-19 - Implementation of an MCP server for all [Apify Actors](https://apify.com/store).

* [ppl-ai/modelcontextprotocol](https://github.com/ppl-ai/modelcontextprotocol) ⭐ 2,458 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-17 - An MCP server implementation that integrates the Sonar API to provide Claude with unparalleled real-time, web-wide research.

* [tavily-ai/tavily-mcp](https://github.com/tavily-ai/tavily-mcp) ⭐ 2,336 | 🐛 49 | 🌐 JavaScript | 📅 2026-08-13 - Search engine for AI agents (search + extract) powered by Tavily
...
* [Xquik-dev/x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 183 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-18 - X/Twitter data MCP server & AI agent skill. REST API and 20 extraction tools for profiles, tweets, followers, and more.
...
* [modelcontextprotocol/slack](https://github.com/modelcontextprotocol/servers/blob/main/src/slack) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - Channel management and messaging capabilities
...
* [carterlasalle/mac\_messages\_mcp](https://github.com/carterlasalle/mac_messages_mcp) ⭐ 314 | 🐛 0 | 🌐 Python | 📅 2026-07-21 - An MCP server that securely interfaces with your iMessage database via the Model Context Protocol (MCP), allowing LLMs to query and analyze iMessage conversations. It includes robust phone number validation, attachment processing, contact management, group chat handling, and full support for sending and receiving messages.
...
* [modelcontextprotocol/postgres](https://github.com/modelcontextprotocol/servers/blob/main/src/postgres) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - Read-only database access with schema inspection
* [bytebase/dbhub](https://github.com/bytebase/dbhub) ⭐ 3,378 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-15 - Universal database MCP server connecting to MySQL, PostgreSQL, SQLite, DuckDB and etc.
* [qdrant/mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant) ⭐ 1,505 | 🐛 74 | 🌐 Python | 📅 2026-08-14 - This repository is an example of how to create a MCP server for Qdrant, a vector search engine.
...
* [neo4j-contrib/mcp-neo4j](https://github.com/neo4j-contrib/mcp-neo4j) ⭐ 979 | 🐛 25 | 🌐 Python | 📅 2026-04-10 - Neo4j graph database server (schema + read/write-cypher) and separate graph database backed memory
* [ClickHouse/mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse) ⭐ 853 | 🐛 54 | 🌐 Python | 📅 2026-08-05 - An MCP server for ClickHouse.
...
* [motherduckdb/mcp-server-motherduck](https://github.com/motherduckdb/mcp-server-motherduck) ⭐ 507 | 🐛 9 | 🌐 Python | 📅 2026-07-27 - Query and analyze data with MotherDuck and local DuckDB
...
* [GreptimeTeam/greptimedb-mcp-server](https://github.com/GreptimeTeam/greptimedb-mcp-server) ⭐ 29 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - A Model Context Protocol (MCP) server implementation for [GreptimeDB](https://github.com/GreptimeTeam/greptimedb) ⭐ 6,552 | 🐛 229 | 🌐 Rust | 📅 2026-08-19.
...
* [keboola/keboola-mcp-server](https://github.com/keboola/keboola-mcp-server) ⭐ 86 | 🐛 39 | 🌐 Python | 📅 2026-08-19 - Keboola Explorer Server MCP server
...
* [modelcontextprotocol/sequentialthinking](https://github.com/modelcontextprotocol/servers/blob/main/src/sequentialthinking) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - Dynamic and reflective problem-solving through thought sequences
...
* [DMontgomery40/deepseek-mcp-server](https://github.com/DMontgomery40/deepseek-mcp-server) ⭐ 349 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-19 - Model Context Protocol server integrating DeepSeek's advanced language models, in addition to [other useful API endpoints](https://github.com/DMontgomery40/deepseek-mcp-server?tab=readme-ov-file#features) ⭐ 349 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-19
...
* [pyroprompts/any-chat-completions-mcp](https://github.com/pyroprompts/any-chat-completions-mcp) ⭐ 156 | 🐛 8 | 🌐 JavaScript | 📅 2025-05-01 - Interact with any OpenAI SDK Compatible Chat Completions API like OpenAI, Perplexity, Groq, xAI and many more.
...
* [modelcontextprotocol/everything](https://github.com/modelcontextprotocol/servers/blob/main/src/everything) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - This MCP server exercises all the features of the MCP protocol. It is a test server for builders of MCP clients.
* [sparfenyuk/mcp-proxy](https://github.com/sparfenyuk/mcp-proxy) ⭐ 2,713 | 🐛 59 | 🌐 Python | 📅 2026-07-20 - Connect to MCP servers that run on SSE transport, or expose stdio servers as an SSE server.
...
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 847 | 🐛 1 | 🌐 Python | 📅 2026-08-06 - Open source (GPL-3.0) autonomous AI penetration testing platform covering web, API, Active Directory and Kubernetes, with proof of exploitation.
...
* [modelcontextprotocol/aws-kb-retrieval-server](https://github.com/modelcontextprotocol/servers/blob/main/src/aws-kb-retrieval-server) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - Retrieval from AWS Knowledge Base using Bedrock Agent Runtime
* [modelcontextprotocol/memory](https://github.com/modelcontextprotocol/servers/blob/main/src/memory) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - Knowledge graph-based persistent memory system
* [screenpipe/screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 21,102 | 🐛 114 | 🌐 Rust | 📅 2026-08-19 - 24/7 local screen & mic recording; MCP server lets agents search OCR, accessibility, and audio transcripts of everything you've seen, said, or heard. Works with Ollama.
* [basicmachines-co/basic-memory](https://github.com/basicmachines-co/basic-memory) ⭐ 3,680 | 🐛 79 | 🌐 Python | 📅 2026-08-19 - Local-first knowledge management system that builds a semantic graph from Markdown files, enabling persistent memory across conversations with LLMs.
* [dmayboroda/minima](https://github.com/dmayboroda/minima) ⭐ 1,048 | 🐛 14 | 🌐 Python | 📅 2026-01-22 - MCP server for RAG on local files
* [StevenStavrakis/obsidian-mcp](https://github.com/StevenStavrakis/obsidian-mcp) ⭐ 723 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-14 - (by Steven Stavrakis) An MCP server for Obsidian.md with tools for searching, reading, writing, and organizing notes.
...
* [modelcontextprotocol/everart](https://github.com/modelcontextprotocol/servers/blob/main/src/everart) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - AI image generation using various models
* [ahujasid/blender-mcp](https://github.com/ahujasid/blender-mcp) ⭐ 26,036 | 🐛 13 | 🌐 Python | 📅 2026-08-16 - Blender integration allowing prompt enabled 3D scene creation, modeling and manipulation.
* [Coding Solo/godot-mcp](https://github.com/Coding-Solo/godot-mcp) ⭐ 5,259 | 🐛 67 | 🌐 JavaScript | 📅 2026-04-16 - A MCP server providing comprehensive Godot engine integration for project editing, debugging, and scene management.
* [zcaceres/mcp-markdownify-server](https://github.com/zcaceres/mcp-markdownify-server) ⭐ 2,915 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-11 - MCP to convert almost anything to Markdown (PPTX, HTML, PDF, Youtube Transcripts and more)
...
* [Pantani/tdmcp](https://github.com/Pantani/tdmcp) ⭐ 34 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-15 - Build real TouchDesigner node networks from plain language (audio-reactive visuals, feedback loops, particles, generative art, projection mapping) with a create→verify→preview loop. Ships a one-click .dxt for Claude Desktop.
...
* [modelcontextprotocol/gdrive](https://github.com/modelcontextprotocol/servers/blob/main/src/gdrive) ⭐ 89,684 | 🐛 518 | 🌐 TypeScript | 📅 2026-08-18 - File access and search capabilities for Google Drive

* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 5,767 | 🐛 188 | 🌐 Python | 📅 2026-08-19 - Interact with Atlassian Cloud products (Confluence and Jira) including searching/reading Confluence spaces/pages, accessing Jira issues, and project metadata.

* [haris-musa/excel-mcp-server](https://github.com/haris-musa/excel-mcp-server) ⭐ 4,117 | 🐛 69 | 🌐 Python | 📅 2026-04-12 - Excel manipulation including data reading/writing, worksheet management, formatting, charts, and pivot table.

* [nowork-studio/NotFair](https://github.com/nowork-studio/NotFair) ⭐ 3,373 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-14 - Open-source Claude Code skills for SEO, GEO, Google Ads, and Meta Ads (\~2.9k stars). Connects to live data via Google Ads MCP, Meta Ads MCP, Google Search Console MCP, and Google Analytics (GA4) MCP for site audits, keyword research, ad audits, and wasted-spend detection.
...
* [MohamedAbdallah-14/unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 97 | 🐛 3 | 🌐 Python | 📅 2026-06-29 - MCP server and CLI that removes named AI writing tells from text: tricolons, em-dash pileups, hedging stacks, sycophancy openers, overused vocab like "delve" and "crucial". Lint-only audit mode included. Five intensity levels.
...
* [esignaturescom/mcp-server-esignatures](https://github.com/esignaturescom/mcp-server-esignatures) ⭐ 39 | 🐛 3 | 🌐 Python | 📅 2026-07-14 - MCP server for eSignatures (<https://esignatures.com>)
...
* [GLips/Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 15,678 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-07 - Give your coding agent direct access to Figma file data, helping it one-shot design implementation.
...
* [stripe/agent-toolkit](https://github.com/stripe/agent-toolkit) ⭐ 1,750 | 🐛 79 | 🌐 TypeScript | 📅 2026-08-19 - The Stripe Model Context Protocol server allows you to integrate with Stripe APIs through function calling. This protocol supports various tools to interact with different Stripe services.
...
* [hello-world-node](https://github.com/anthropics/dxt/tree/main/examples/hello-world-node) ⭐ 2,083 | 🐛 95 | 🌐 TypeScript | 📅 2026-05-26 - Basic MCP server with simple time tool
